...
import img1 from '../../../images/slider/geEnglish2.jpg';
import img2 from '../../../images/slider/geEnglish.jpg';
import img3 from '../../../images/slider/geEnglish3.jpg';

import './GeneralEnglish.css';

const generalEnglishSliderData = [
    {
        src: img1,
    ...
    return (
        <React.Fragment>
            <Courses
                ...
                sliderData={generalEnglishSliderData}
            />
        </React.Fragment>
    );
}
